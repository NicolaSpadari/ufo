        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div class="flex lg:flex-1">
                <a href="#" class="-m-1.5 p-1.5">
                    ...
                    <SvgoLogo class="!h-8 !w-auto !text-emerald-500" :alt="appName" />
                </a>
            </div>
            ...
            <PopoverGroup class="hidden lg:flex lg:gap-x-12">
                <Popover class="relative">
                    <PopoverButton class="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900">
                        Product
                        <UIcon name="i-heroicons-chevron-down" class="h-5 w-5 flex-none text-gray-400" aria-hidden="true" />
                    </PopoverButton>
                        ...
                        <div class="space-y-2 py-6">
                            <Disclosure v-slot="{ open }" as="div" class="-mx-3">
                                <DisclosureButton class="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                                    Product
                                    <UIcon name="i-heroicons-chevron-down" class="h-5 w-5 flex-none" :class="[open ? 'rotate-180' : '']" aria-hidden="true" />
                                </DisclosureButton>
...
<script lang="ts" setup>
    ...
    const products = [
        { name: "Analytics", description: "Get a better understanding of your traffic", href: "#", icon: "i-heroicons-chart-pie" },
        { name: "Engagement", description: "Speak directly to your customers", href: "#", icon: "i-heroicons-cursor-arrow-rays" },
        { name: "Security", description: "Your customers' data will be safe and secure", href: "#", icon: "i-heroicons-finger-print" },
        { name: "Integrations", description: "Connect with third-party tools", href: "#", icon: "i-heroicons-squares-plus" },
        { name: "Automations", description: "Build strategic funnels that will convert", href: "#", icon: "i-heroicons-arrow-path" }
    ];
    const callsToAction = [
