		...
		<MenubarMenu value="order">
			...
			<MenubarPortal>
				<MenubarContent
					...
					will-change="transform,opacity" min-w="220px" rounded-md bg-white p-1 shadow-xl outline-none
					align="start"
					:side-offset="5"
					:align-offset="-3"
				>
					<MenubarRadioGroup v-model="order">
						<MenubarRadioItem
							...
							:key="mode"
							class="relative h-[25px] flex pointer select-none items-center rounded-[3px] px-[5px] pl-[20px] text-[13px] text-green-600 leading-none outline-none data-[disabled]:pointer-events-none data-[highlighted]:bg-green9 data-[disabled]:text-mauve8 data-[highlighted]:text-green1"
							:value="mode"
						>
