<template>
	<MenubarRoot flex rounded-md bg-mauve3 p-1 shadow-lg>
		<MenubarMenu value="order">
			<MenubarTrigger
				flex-center select-none gap-1 rounded px-3 py-2 text-sm text-grass11 leading-none outline-none hover="bg-green4"
				ui-open="bg-green4"
			>
				<span>Order by: </span>
			...
			<MenubarPortal>
				<MenubarContent
					will-change="transform,opacity" animate-duration-400 class="[animation-timing-function:_cubic-bezier(0.16,_1,_0.3,_1)]" shadow="[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),_0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)]" min-w="220px" rounded-md bg-white p-1 outline-none
					align="start"
					:side-offset="5"
					:align-offset="-3"
				>
